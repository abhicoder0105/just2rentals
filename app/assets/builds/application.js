...
var FrameLoadingStyle, FrameElement, drive, submitter, Config, forms, config, FetchResponse, LimitedSet, recentRequests, FetchMethod, FetchEnctype, FetchRequest, AppearanceObserver, StreamMessage, identity, LRUCache, PREFETCH_DELAY, PrefetchCache, cacheTtl, prefetchCache, FormSubmissionState, FormSubmission, Snapshot, FormSubmitObserver, View, FrameView, LinkInterceptor, LinkClickObserver, FormLinkClickObserver, Bardo, Renderer, FrameRenderer, Idiomorph, DefaultIdiomorphCallbacks, MorphingFrameRenderer, ProgressBar, HeadSnapshot, PageSnapshot, ViewTransitioner, defaultOptions, TimingMetric, VisitState, SystemStatusCode, Direction, Visit, BrowserAdapter, CacheObserver, FrameRedirector, History, LinkPrefetchObserver, unfetchableLink, linkToTheSamePage, linkOptsOut, nonSafeLink, isUJS, eventPrevented, Navigator, PageStage, PageObserver, ScrollObserver, StreamMessageRenderer, StreamObserver, ErrorRenderer, PageRenderer, MorphingPageRenderer, SnapshotCache, PageView, Preloader, Cache, Session, deprecatedLocationPropertyDescriptors, session, cache, sessionNavigator, Turbo, TurboFrameMissingError, FrameController, StreamActions, StreamElement, StreamSourceElement;
var init_turbo_es2017_esm = __esm({
  "node_modules/@hotwired/turbo/dist/turbo.es2017-esm.js"() {
    ...
    FrameElement = class _FrameElement extends HTMLElement {
    ...
    PREFETCH_DELAY = 100;
    PrefetchCache = class extends LRUCache {
    ...
    FormSubmission = class _FormSubmission {
    ...
    PageSnapshot = class _PageSnapshot extends Snapshot {
    ...
    MorphingPageRenderer = class extends PageRenderer {
      static renderElement(currentElement, newElement) {
    ...
    SnapshotCache = class extends LRUCache {
      constructor(size) {
        super(size, toCacheKey);
      }
      get snapshots() {
    ...
    ({ cache, navigator: sessionNavigator } = session);
    ...
    StreamElement = class _StreamElement extends HTMLElement {
